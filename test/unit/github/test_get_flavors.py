...
def test_get_flavors(tmp_path):
    ...
    build_config = BuildConfig(
        root=tmp_path,
        base_branch=base_build_config.base_branch,
        ignore_paths=base_build_config.ignore_paths,
        docker_build_repository=base_build_config.docker_build_repository,
        docker_release_repository=base_build_config.docker_release_repository,
