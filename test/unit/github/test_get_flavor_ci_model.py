...
def test_get_flavor_ci_model(build_config_with_flavor_environment, test_flavor_config):
    res = lib_get_flavor_ci_model.get_flavor_ci_model(build_config_with_flavor_environment, "flavor_a")
    assert res == test_flavor_config


def test_get_flavor_ci_model_fails_with_wrong_json(build_config_environment, test_flavor_config):
