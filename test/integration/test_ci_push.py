...
EXPECTED_TAG_INFO_HASHES = [
    _CiTestTagInfo(build_step="base_test_build_run", tag_suffix="GUA7R5J3UM27WOHJSQPX2OJNSIEKWCM5YF5GJXKKXZI53LZPV75Q"),
    _CiTestTagInfo(build_step="flavor_test_build_run", tag_suffix="G2OIMXJ2S3VS2EUAQNW4KWQLX3B2C27XYZ2SDMF7TQRS3UMAUWJQ"),
    _CiTestTagInfo(build_step="release", tag_suffix="MNWZZGSSFQ6VCLBDH7CZBEZC4K35QQBSLOW5DSYHF3DFFDX2OOZQ"),
    ]
...
@pytest.mark.parametrize("test_ci_config", [_CiTestConfig(expected_tag_infos=EXPECTED_TAG_INFO_RELEASE, build_name="test-build_1.2.3"),
...
def test(flavors_path, test_ci_config):
    ...
    with LocalDockerRegistryContextManager("test_ci_push") as registry:
        ...
        expected_images = {
            "name": "test_ci_push",
            "tags": [tag_info.build_tag_name(flavor_name, arch) for tag_info in test_ci_config.expected_tag_infos]
        }
